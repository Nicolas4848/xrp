...
export default function CTA() {
  return (
    <section className="relative py-24 bg-white dark:bg-slate-950 overflow-hidden transition-colors duration-300">
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[1000px] h-[600px] bg-blue-50/50 dark:bg-blue-900/10 rounded-full blur-[120px] pointer-events-none" />

      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">

        {/* Main CTA Container - Glass/Gradient Border Style */}
        <div className="relative rounded-[2.5rem] p-1 bg-gradient-to-br from-purple-100 via-white to-blue-100 dark:from-purple-900/30 dark:via-slate-900 dark:to-blue-900/30 shadow-2xl shadow-blue-900/10 dark:shadow-none">
              ...
              <div className="space-y-8 text-center lg:text-left">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-2">
                  <Link href={'/dapp'} className="w-full sm:w-auto">
                    <button className="w-full group relative bg-slate-900 dark:bg-white hover:bg-purple-700 dark:hover:bg-slate-200 text-white dark:text-slate-900 font-bold text-lg px-10 py-5 rounded-2xl transition-all shadow-xl hover:shadow-2xl hover:-translate-y-1 flex items-center justify-center gap-3 overflow-hidden">
                      {/* Button Shimmer */}
